...
Although `smashy` is currently still evolving, it can already be used for optimization. All necessary functions work and are [documented](https://mlr-org.github.io/smashy/reference/index.html), see also [**Getting Help**](#getting-help) below.
