...
#' @description
#'
#' `smashy` offers both an [`Optimizer`][bbotk::Optimizer] and a [`Tuner`][mlr3tuning::Tuner] for general
#' smashy-optimization, but generally the [`configure_smashy()`]-function should be used.
"_PACKAGE"
...
and try again.")
  ...
  options(smashy.testing = getOption("smashy.testing") %??% FALSE)
}  # nocov end
